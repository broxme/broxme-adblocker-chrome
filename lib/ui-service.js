...
adguard.ui = (function (adguard) { // jshint ignore:line
    ...
    const extensionStoreLink = (function () {
        ...
        return `https://broxme.com/adblocker?action=${action}&from=options_screen&app=browser_extension`;
    })();

    const THANKYOU_PAGE_URL = 'https://broxme.com/thankyou';
    ...
    function showVersionUpdatedPopup(currentVersion, previousVersion) {
        ...
        const message = {
            ...
            changelogHref: 'https://broxme.com/adblocker?action=github_version_popup&from=version_popup&app=browser_extension',
            ...
            offerButtonHref: 'https://broxme.com/adblocker?action=learn_about_adbloker&from=version_popup&app=browser_extension',
    ...
    var openSiteReportTab = function (url) {
        ...
        if (domain) {
            openTab(`https://broxme.com/bug?domain=${encodeURIComponent(domain)}&product_type=adblocker_extention&utm_source=adblocker_extension`);
        }
    };
    ...
    const openAbuseTab = function (url) {
        ...
        openTab(`https://www.broxme.com/feedback?product_type=Ext&product_version=${
