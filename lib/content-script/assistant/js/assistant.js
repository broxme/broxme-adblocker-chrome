...
function Wot() {
  ...
  var WOT_URL = 'https://www.mywot.com/';
  var wotData = null;
...
function Settings() {
  var Constants = {
    ...
    REPORT_URL: 'https://feedback.broxme.com/{0}/'
  };
  var MenuItemsNames = {
  ...
  var setAdguardSettings = function setAdguardSettings(settings) {
    if (typeof settings === 'undefined') {
      src_log.info('No BroxMe Adblocker API Found');
      return;
    }
...
function UIButton() {
  ...
  var show = function show() {
    ...
    if (!checkRequirements()) {
      src_log.info('Environment doesn\'t satisfy requirements, so don\'t show BroxMe Adblocker');
      return;
    }
