...
adguard.notifications = (function (adguard) {
    ...
    const newYearNotification = {
        ...
        locales: {
            en: {
                title: 'BroxMe Adblocker wishes you happy holidays',
                btn: 'Get your present',
            },
            de: {
                title: 'BroxMe Adblocker wünscht Ihnen frohe Festtage!',
                btn: 'HOLEN SIE SICH IHR GESCHENK',
            },
            ko: {
                title: 'BroxMe Adblocker는 행복한 크리스마스가 되길 바랍니다',
                btn: '선물 받기',
            },
            ru: {
                title: 'BroxMe Adblocker поздравляет вас с праздниками',
                btn: 'Получить подарок!',
            },
            ja: {
                title: 'BroxMe Adblockerからのクリスマスプレゼント',
                btn: 'プレゼントをGET',
            },
            fr: {
                title: 'BroxMe Adblocker vous souhaite de joyeuses fêtes !',
                btn: 'VOIR CADEAU',
            },
            it: {
                title: 'BroxMe Adblocker vi augura buone feste!',
                btn: 'VEDERE IL REGALO',
            },
        },
        text: '',
        url: 'https://broxme.com/adblocker?action=ny2020_notify&from=popup&app=browser_extension',
        from: '24 December 2020 00:00:00',
