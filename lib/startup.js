...
adguard.initialize = function () {
    function onLocalStorageLoaded() {
        adguard.console.info('Starting broxme adblocker... Version: {0}. Id: {1}', adguard.app.getVersion(), adguard.app.getId());
        ...
        const uninstallUrl = 'https://broxme.com/survey?action=adblocker_uninstal_ext&from=background&app=browser_extension';
